...
QT_MOC_LITERAL(1, 9, 9), // "dlgRetrun"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 21) // "on_pushButton_clicked"

    },
    "MyDialog\0dlgRetrun\0\0on_pushButton_clicked"
};
...
void MyDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dlgRetrun((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyDialog::dlgRetrun)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyDialog::dlgRetrun(int _t1)
{
